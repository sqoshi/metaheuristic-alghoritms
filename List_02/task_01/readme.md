...
3. Generujemy sąsiada neighbour aktualnego rozwiązania x.(Teraz tak, skoro algorytmy metaheurystyczne w pewien sposób 
bazują na rozwiązaniach przybliżonych,a poza tym odgórnie wiem, że pracuję nad funkcją Salomona i mogę np.
 strzelić, że minimum jest osiągane w okolicy przedziału (-1,1) to czy nie mogę np gdy wartość aktualnego X osiągnie wartosc z tego przedziału, zmienić sposób generowania
 sąsiada lub np zmienić precyzję na mniej lub bardziej dokładną)
