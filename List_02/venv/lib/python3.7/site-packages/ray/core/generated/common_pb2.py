...
_ACTORCREATIONTASKSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='is_asyncio', full_name='ray.rpc.ActorCreationTaskSpec.is_asyncio', index=5,
