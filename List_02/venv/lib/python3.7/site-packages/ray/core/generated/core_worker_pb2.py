...
_PUSHTASKREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='caller_version', full_name='ray.rpc.PushTaskRequest.caller_version', index=6,
      number=7, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='callerVersion', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_KILLACTORREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='no_reconstruction', full_name='ray.rpc.KillActorRequest.no_reconstruction', index=2,
      number=3, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='noReconstruction', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
